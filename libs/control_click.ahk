...
ControlClick_UDF(WinTitle="", X = 0, Y = 0, count_click = 1,WinText="", ExcludeTitle="", ExcludeText="")
{
...
ControlMouseMove_UDF(WinTitle="", X = 0, Y = 0, WinText="", ExcludeTitle="", ExcludeText="")
{
    hwnd:=ControlFromPoint(X, Y, WinTitle, WinText, cX, cY
    , ExcludeTitle, ExcludeText)
    PostMessage, 0x200, 0, cX&0xFFFF | cY<<16,, ahk_id %hwnd% ; WM_MOUSEMOVE
    PostMessage, 0x202, 0, cX&0xFFFF | cY<<16,, ahk_id %hwnd% ; WM_MOUSEMOVE
}

ControlDoubleClick_UDF(WinTitle="", X = 0, Y = 0, WinText="", ExcludeTitle="", ExcludeText="")
{
    hwnd:=ControlFromPoint(X, Y, WinTitle, WinText, cX, cY
    , ExcludeTitle, ExcludeText)
